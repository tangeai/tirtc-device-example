...
#define TIRTC_SESSION_SEND_BUFFER_DROP_PCT              80U
#define TIRTC_SESSION_SEND_BUFFER_LOG_PERIOD_MS         1000U

/* Bound queued latency and PSRAM use while native 1280x960 uplink and downlink coexist. */
#define TIRTC_SESSION_VIDEO_TX_QUEUE_LEN                2
#define TIRTC_SESSION_VIDEO_TX_TARGET_BACKLOG           1
...
#define TIRTC_SESSION_VIDEO_TX_PREALLOC_BYTES           (512U * 1024U)
