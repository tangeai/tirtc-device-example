...
static esp_err_t app_ui_on_stop_contact_scan(void *ctx)
{
    ...
    BaseType_t task_ret = xTaskCreate(app_ui_stop_contact_scan_task,
                                      "call_scan_stop",
                                      4096,
                                      NULL,
                                      5,
                                                   ...
                                                   void *ctx)
{
    ...
    return app_start_tirtc_config_scan((app_scan_preview_cb_t)preview_cb,
...
static esp_err_t app_ui_on_stop_tirtc_config_scan(void *ctx)
{
    ...
    BaseType_t task_ret = xTaskCreate(app_ui_stop_tirtc_config_scan_task,
                                      "tirtc_scan_stop",
                                      4096,
                                      NULL,
                                      5,
                                                     ...
                                                     void *ctx)
{
    ...
    return app_start_wechat_contact_scan((app_scan_preview_cb_t)preview_cb,
...
static esp_err_t app_ui_on_stop_wechat_contact_scan(void *ctx)
{
    ...
    BaseType_t task_ret = xTaskCreate(app_ui_stop_wechat_contact_scan_task,
                                      "wechat_scan_stop",
                                      4096,
                                      NULL,
                                      5,
