...
static thing_service_registry_runtime_t s_registry;
...
esp_err_t thing_service_registry_refresh(void)
{
    ...
    candidate = heap_caps_calloc(1, sizeof(*candidate), MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT);
