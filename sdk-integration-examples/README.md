...
本目录提供面向移植和 SDK 学习的最小 TiRTC 集成示例，以及不依赖产品 UI 和板级外设的
轻量协议示例。最小示例聚焦联网、时间同步、TiRTC 初始化、上线、连接、音视频收发、
订阅控制和资源释放；AT ThingConnect 示例进一步覆盖开发者平台业务状态机。
...
| ESP32-S3 | [AT ThingConnect 示例](esp32-s3-at-thingconnect/README.md) | `0.2.0` | `2.2.1` | ESP-IDF `5.5.4` | Public tag `esp32-s3-at-thingconnect-v0.2.0` |
...
- ESP32-S3 AT ThingConnect 示例在最小联网工程之上增加开发者平台绑定、AI 对讲和设备互呼，
  所有设备侧操作都通过串口 AT 完成，媒体使用预录测试素材。
