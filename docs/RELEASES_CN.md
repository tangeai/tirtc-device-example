...
| ESP32-S3 Device Monitor | `1.9.0` | [`esp32-s3-device-monitor-v1.9.0`](https://github.com/tangeai/tirtc-device-example/releases/tag/esp32-s3-device-monitor-v1.9.0) |
...
| S3 Device Monitor | `esp32s3-tirtc-device-monitor-full-v1.9.0.bin` | `16777216` | `1e5ce092a76266a1997234cc20e2c0692fa59526ed856634f68a8f54d40f7499` | ESP Tool，地址 `0x0` |
| S3 Device Monitor | `esp32s3-tirtc-device-monitor-ota-v1.9.0.bin` | `7599904` | `3cdebe0df0946fc7bee65c921f94796c080bc1e03025370b1b76a5cbe560d137` | OTA app，不写入 `0x0`；分区剩余 `198880` bytes |
...
S3 Device Monitor `1.9.0` 的 RTC 业务是双向音频，摄像头只用于二维码扫描。该版本不再生成
`storage.bin`；完整镜像中的未使用分区保持擦除态。`1.8.1` Release 继续作为历史版本保留，
不同版本的 full、OTA app 或分段文件不能混用。
