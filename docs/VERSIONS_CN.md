...
| 完整应用 | ESP32-S3 Device Monitor | `1.9.0` | `2.3.0 mini` | `v1.9.0` / `a64422b` / tree `b29d408` | `esp32-s3-device-monitor-v1.9.0` |
...
ESP32-S3 Device Monitor `1.9.0` 的完整开发来源为 Tag `v1.9.0`、commit
`a64422b0efdebe6c303370effafd52bbf51593d1`、tree
`b29d4080a43db0a2b8f2e35f095c5c45f3c1f4c7`。`1.8.1` 的微信体验版补丁仍保留在源码和
历史 Release 中；当前版本没有把 `wx_version_type=2` 回退。
...
| S3 Device Monitor `1.9.0` | 来源 Tag/commit/tree、SDK `2.3.0 mini`、音频产品边界、默认配置和凭据范围已核对 | 最终公开代码快照正式干净构建通过；app `7599904` 字节、SHA-256 `3cdebe0df0946fc7bee65c921f94796c080bc1e03025370b1b76a5cbe560d137`、分区剩余 `198880` 字节 | 源码、完整镜像与 OTA app；容量余量较紧 |
