...
| 完整应用 | ESP32-S3 Device Monitor | `1.8.1` | `2.2.0` | `v1.8.1` / `9aff1ad` | `esp32-s3-device-monitor-v1.8.1` |
...
| S3 Device Monitor `1.8.1` | 来源 Tag、SDK、单一功能补丁、版本和凭据已核对 | ESP-IDF `5.5.4` 正式干净构建通过；app `7,449,184` 字节，SHA-256 `b552e3971a0fab7999384f6af0c841b779913c11227cde4c03f6cc3a143f6e3c` | 源码、完整镜像与 OTA app |
