...
更新 SDK 时，只从经过版本、BuildInfo、build contract 与 SHA256 核对的
交付包同步 `include/`、`lib/esp32s3/libTiRTC.a`、`manifest/` 和
`VERSION.md`。不得从脏示例工作区盲目覆盖，也不要恢复旧的
`tirtc_compat.c` 或 `*_sndv` 临时补丁。
