...
esp_err_t app_at_commands_start(void) {
  ...
  /* The Waveshare P4 board exposes UART0 through its CH343 USB bridge. */
  config.transport = (at_transport_config_t)AT_TRANSPORT_UART_DEFAULT();
  config.transport.tx_pin = 37;
  config.transport.rx_pin = 38;
#endif
