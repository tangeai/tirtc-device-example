...
typedef esp_err_t (*at_server_command_handler_t)(
    const at_server_request_t *request, void *context);
...
/*
 * Drain every URC queued before this call. This is restricted to command
 * handlers running on the AT task and is intended for protocol-mode barriers.
 */
